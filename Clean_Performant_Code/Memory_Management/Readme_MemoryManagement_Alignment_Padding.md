...
Variablen eines C/C++ Programms liegen im Arbeitsspeicher (RAM) des Prozesses &ndash; was für eine gewaltige Aussage :).
Nicht ganz so trivial ist aber die Betrachtung, an welchen Adressen im Speicher Variablen ablegegt sein können.
Hier gibt es eine Reihe von Einschränkungen zu beachten, die vor allem im Umfeld des *Embedded Programming* eine Rolle spielen.
